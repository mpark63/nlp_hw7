...
eve = Character("Eve", ["English"], 
                ...
                conversational_style="You ask personal questions; you sometimes share what you've heard (or overheard) from others.", 
                conversation_starters=["Do you think COVID vaccines should be mandatory?"])
...
shorty = Character("Shorty", ["English"], 
                "an introvert who knows a lot but doesn't say a lot",
                conversational_style="You don't like to talk much, but you will if you have to.",
                conversation_starters=["Do you think Donald Trump was a good president?",
                                       "Do you think Joe Biden has been a good president?"])
